...
func Configure(queueID, capacity int64) Wireup {
	return Wireup{
		queueID:  queueID,
		capacity: capacity,
		groups:   [][]Consumer{},
...
func (this Wireup) Build() Disruptor {
	...
	writer := NewWriter(this.queueID, written, upstream, this.capacity)
...
func (this Wireup) BuildShared() SharedDisruptor {
	...
	writer := NewSharedWriter(this.queueID, writerBarrier, upstream)
...
func (this Wireup) buildReaders(consumerIndex, cursorIndex int, written *Cursor, upstream Barrier) ([]*Reader, Barrier) {
	...
	for _, consumer := range this.groups[consumerIndex] {
		...
		reader := NewReader(this.queueID, cursor, written, upstream, consumer)
